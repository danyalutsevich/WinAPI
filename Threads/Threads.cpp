...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		hwndBUTTON1 = CreateWindowW(L"Button", L"Thread", WS_CHILD | WS_VISIBLE, 50, 50, 75, 23, hWnd, (HMENU)CMD_BUTTON_1, hInst, 0);
...
DWORD WINAPI ThreadProc(LPVOID params) {
	...
	_itow_s(counter,buff, 10);
	SendMessageW(mainWindow, WM_SETTEXT, 0, (LPARAM)buff);
	MessageBoxW(NULL, buff, L"Works", MB_OK);
