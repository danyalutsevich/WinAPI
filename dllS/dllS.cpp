...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		button = CreateWindowW(L"Button", L"link", WS_CHILD | WS_VISIBLE, 10, 10, 75, 23, hWnd, (HMENU)CMD_BUTTON1, hInst, NULL);
		break;
	case WM_COMMAND:
	{
...
void buttonClick() {
	...
	if (dll == NULL) {
		...
		if (sqr_fun) {
			...
			MessageBoxW(NULL, L"error", L"proc", MB_OK | MB_ICONERROR);
		}
		MessageBoxW(NULL, L"ok", L"dll", MB_OK | MB_ICONINFORMATION);
	}
